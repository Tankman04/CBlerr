...
def main() -> int:
    ...
    wc.lpszClassName = "CBlerrEmpty".data
    
    RegisterClassA(&wc)
    
    let hWnd = CreateWindowExA(0, "CBlerrEmpty".data, "CBlerr mty".data, 13565952, 100, 100, 800, 600, 0 as *void, 0 as *void, hInstance, 0 as *void)
