...
def main() -> int:
    ...
    wc.lpszClassName = "CBlerrBtn".data
    
    RegisterClassA(&wc)
    let hWnd = CreateWindowExA(0, "CBlerrBtn".data, "empty".data, 13565952, 100, 100, 400, 300, 0 as *void, 0 as *void, hInstance, 0 as *void)
    
    CreateWindowExA(0, "BUTTON".data, "I don't do shit".data, 1342177280, 120, 100, 150, 40, hWnd, 1001 as *void, hInstance, 0 as *void)
